      ...
      <section className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/40">
        ...
        <div className="grid gap-5 p-5 sm:p-8 lg:grid-cols-[minmax(0,1fr)_280px]">
          ...
          <aside className="space-y-4">
            ...
            <a href={`data:text/plain;charset=utf-8,${encodeURIComponent(fileText)}`} download={`${data.orderCode}.txt`} className="button-secondary flex w-full items-center justify-center gap-2 px-4 py-3"><Download size={16} />Tải nhanh trong trình duyệt</a>
          </aside>
        </div>
      </section>
    </div>
