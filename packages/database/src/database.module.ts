...
const models: ModelDefinition[] = [
  ...
  { name: 'Coupon', schema: schemas.CouponSchema, collection: 'coupons' },
  { name: 'CouponRedemption', schema: schemas.CouponRedemptionSchema, collection: 'coupon_redemptions' },
  { name: 'CustomerEvent', schema: schemas.CustomerEventSchema, collection: 'customer_events' },
